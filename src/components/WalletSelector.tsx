...
const WALLET_ICONS: Record<string, string> = {
  ...
  'nightly': 'data:image/svg+xml;base64,',
  'okx wallet': 'data:image/svg+xml;base64,',
};
...
export const getWalletIcon = (walletName: string, fallbackIcon?: string): string => {
  ...
  // Always use our custom icons first
  ...
  return (
    <WalletItem wallet={wallet} onConnect={onConnect}>
      <WalletItem.ConnectButton asChild>
        <button
          className="w-full flex items-center justify-center gap-3 p-3.5 bg-white hover:bg-gray-50 rounded-xl transition-colors border border-gray-200"
        >
          {isGoogle && <GoogleIcon />}
          {isApple && <AppleIcon />}
...
function WalletButton({
  ...
  // Always use custom icon first, then fallback to adapter icon
        ...
        >
          {walletIcon ? (
            ...
            <div className="w-10 h-10 rounded-xl bg-[#3a4f60] flex items-center justify-center opacity-50">
              <span className="text-white font-bold">{baseName[0]}</span>
            </div>
          )}
    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="w-full max-w-sm bg-[#1c2b3a] border border-[#3a4f60] rounded-2xl shadow-2xl flex flex-col max-h-[85vh]"
