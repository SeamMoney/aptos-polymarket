        ...
        <div className="relative">
          {connected && account ? (
              ...
              <AnimatePresence>
                {showAccountMenu && (
                  <motion.div
                    ...
                    exit={{ opacity: 0, y: -10 }}
                    className="absolute right-0 top-full mt-2 w-72 bg-poly-card border border-poly-border rounded-xl shadow-2xl overflow-hidden z-50"
                  >
                    <div className="p-4">
                      ...
                      <div className="flex items-center gap-2 mb-4">
                        ...
                        {isXChainWallet && (
                          <span className="px-1.5 py-0.5 bg-orange-500/20 text-orange-400 text-[10px] rounded-full">
                            X-Chain
                          </span>
                        )}
                      </div>
                      ...
                      {isXChainWallet && (
                        <div className="mb-4 p-3 bg-orange-500/10 border border-orange-500/30 rounded-lg">
                          ...
                          <div className="text-gray-400 text-xs">
                            Your wallet is connected to Aptos via Derived Account Abstraction (AIP-113)
                          </div>
                        </div>
                      )}
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                onClick={() => setShowWalletSelector(true)}
                className="px-4 py-2 bg-[#60a5fa] hover:bg-[#3b82f6] text-white font-semibold rounded-xl transition-all"
              >
                Sign Up
              </button>
            </div>
    ...
    <nav className="md:hidden fixed bottom-0 left-0 right-0 z-50 bg-poly-dark/95 backdrop-blur-lg border-t border-poly-border">
      <div className="flex items-center justify-around py-1">
        ...
        >
          ...
          <span className="text-[10px]">HFT</span>
        </a>
      </div>
    </nav>
    </>
