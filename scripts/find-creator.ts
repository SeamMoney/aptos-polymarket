/**
 * Find which wallet key maps to the V3 contract address
 */
...
// V3 contract = market creator likely
const TARGET = "0xa2e5e47aab07fed78a3bcf95135ee2dad20c547499c94cb16a3e047859ffa7e1";

console.log("Looking for wallet that maps to:", TARGET);
console.log("");
